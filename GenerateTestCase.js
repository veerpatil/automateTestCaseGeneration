...
async function generateContent() {
    try {
        ...
        const response = await axios.get("https://veer1109.atlassian.net/rest/api/2/issue/"+id+"?fields=description",{
            headers: {
                "Authorization": `Basic `
            } 
        });
      ...
      const req = {
        contents: [{role: 'user', parts: [{text: 'Give me Test cases in cypress from ' + desc }]}],
      };
    ...
    //     data
    // };
    // const postres = await axios.post("https://veer1109.atlassian.net/rest/api/2/issue/GEN-1/comment", {
    //     body: body
    // },{
    //     headers: {
    //         headers: {
